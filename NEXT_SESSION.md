...
로비 실측 기준값 — **폼에 항목을 추가했다면 이 값과 대조하세요.** (2026-09-08 기준)

| 뷰포트 | 안전영역 | 싱글+규칙 | 방 만들기+규칙 | 방 만들기+충돌 | 방 만들기+관전 | 참가+초대 |
| --- | --- | --- | --- | --- | --- | --- |
| 1280×900 | 738×628 | 706×362 | 706×404 | 706×404 | 706×404 | 484×508 |
| 1920×1080 | 885×754 | 717×362 | 717×404 | 717×404 | 717×404 | 573×601 |
| 390×844 | 371×589 | 358×529 | 358×534 | 358×534 | 358×534 | 358×364 |
...
>
> 같은 날 **혼자 놀기**의 시작 버튼도 초록 막대에서 가로 나무 팻말 그림이 되어
> 305 → 362px(모바일 485 → 529px)이 됐습니다. 이쪽은 세로 여유가 넉넉해 요청한 크기를
> 그대로 넣을 수 있었습니다.
>
