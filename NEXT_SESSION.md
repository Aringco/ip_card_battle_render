...
| 게임 규칙 | 펼치면 **세로로** 자랍니다. 대신 확대가 1로 내려가고 제출 버튼이 40px로 줄어듭니다(2026-09-08에 2열에서 되돌림) |
...
로비 실측 기준값 — **폼에 항목을 추가했다면 이 값과 대조하세요.** (2026-09-08 기준 — 규칙 세로 롤백까지 반영)

| 뷰포트 | 안전영역 | 싱글+규칙 | 방 만들기+규칙 | 방 만들기+충돌 | 방 만들기+관전 | 참가+초대 |
| --- | --- | --- | --- | --- | --- | --- |
| 1280×900 | 738×628 | 358×509 | 358×547 | 358×547 | 358×547 | 484×521 |
| 1920×1080 | 885×754 | 358×509 | 358×547 | 358×547 | 358×547 | 573×616 |
| 390×844 | 371×589 | 358×495 | 358×534 | 358×534 | 358×534 | 358×374 |
...
> 다시 재야 합니다.**
>
> **2026-09-08 오후에 규칙 펼침이 2열 → 세로로 되돌아가면서 표가 크게 바뀌었습니다.**
> 카드 폭이 706 → **358px**(2열을 안 쓰니 넓힐 이유가 없다)이 되고 키는 405 → **547px**가
> 됐습니다. 1280×900의 스테이지가 590px이라 **여유가 43px뿐입니다** — 규칙 항목을 하나만
> 더해도 넘칩니다.
>
