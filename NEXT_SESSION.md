...
로비 실측 기준값 — **폼에 항목을 추가했다면 이 값과 대조하세요.** (2026-09-07 기준)

| 뷰포트 | 안전영역 | 싱글+규칙 | 방 만들기+규칙 | 방 만들기+충돌 | 방 만들기+관전 | 참가+초대 |
| --- | --- | --- | --- | --- | --- | --- |
| 1280×900 | 738×628 | 706×305 | 706×367 | 706×367 | 706×367 | 484×508 |
| 1920×1080 | 885×754 | 717×305 | 717×367 | 717×367 | 717×367 | 573×601 |
| 390×844 | 371×589 | 358×485 | 358×534 | 358×534 | 358×534 | 358×364 |
...
> (365 → 367, 모바일 530 → 534). 아이콘이 글자보다 조금 높기 때문이고, 넘치지 않습니다.
