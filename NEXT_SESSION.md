# 다른 PC에서 이어서 작업하기 — 2026-09-05 기준 (관전자 자리까지)
...
로비 실측 기준값 — **폼에 항목을 추가했다면 이 값과 대조하세요.** (2026-09-05 기준)

| 뷰포트 | 안전영역 | 싱글+규칙 | 방 만들기+규칙 | 방 만들기+충돌 | 방 만들기+관전 | 참가+초대 |
| --- | --- | --- | --- | --- | --- | --- |
| 1280×900 | 738×628 | 706×343 | 706×486 | 706×508 | 706×486 | 484×526 |
| 1920×1080 | 885×754 | 717×343 | 717×486 | 717×508 | 717×486 | 627×623 |
| 390×844 | 371×589 | 358×483 | 358×530 | 358×530 | 358×530 | 358×364 |

> `방 만들기+관전`은 `방 만들기+규칙`과 **같아야** 합니다 — 관전자 안내가 설명 줄을
> 갈아끼우기만 하므로 높이가 늘지 않는다는 뜻입니다. 커졌다면 안내를 새 줄로 되돌린 것입니다.
